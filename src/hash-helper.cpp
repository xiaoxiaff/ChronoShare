...
typedef transform_iterator<hex_from_4_bit<string::const_iterator::value_type>,
                           transform_width<string::const_iterator, 4, 8,
                                           string::const_iterator::value_type>> string_from_binary;
...
typedef transform_width<transform_iterator<hex_to_4_bit<string::const_iterator::value_type>,
                                           string::const_iterator>,
                        8, 4> string_to_binary;
...
Hash::FromString(const std::string& hashInTextEncoding)
{
  ...
  unsigned char* end = copy(string_to_binary(hashInTextEncoding.begin()),
                            string_to_binary(hashInTextEncoding.end()), retval->m_buf);
