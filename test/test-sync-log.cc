...
//  std::cout << "hashToString" << DigestComputer::digestToString(*hash) << std::endl;
//  BOOST_CHECK_EQUAL(DigestComputer::digestToString(*hash) , "7a6f2c1eefd539560d2dc3e5542868a79810d0867db15d9b87e41ec105899405");
//
...
//  hash = db.RememberStateInStateLog();
//  BOOST_CHECK_EQUAL(DigestComputer::digestToString(*hash), "2ff304769cdb0125ac039e6fe7575f8576dceffc62618a431715aaf6eea2bf1c");
//
//  db.UpdateDeviceSeqNo(Name("/alex"), 2);
//  hash = db.RememberStateInStateLog();
//  BOOST_CHECK_EQUAL(DigestComputer::digestToString(*hash), "2ff304769cdb0125ac039e6fe7575f8576dceffc62618a431715aaf6eea2bf1c");
...
//  hash = db.RememberStateInStateLog();
//  BOOST_CHECK_EQUAL(DigestComputer::digestToString(*hash), "5df5affc07120335089525e82ec9fda60c6dccd7addb667106fb79de80610519");
//
